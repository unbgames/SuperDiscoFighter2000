...
TitleScene::TitleScene()
{
    ...
    Sprite* titleSprite = new Sprite(*title, ASSETS_PATH("/img/menu.jpg"));
    ...
    titleMessage->AddComponent(new Text(*titleMessage, ASSETS_PATH("/font/60sPop.ttf"), 60, Text::TextStyle::BLENDED, "Press Space to dance!", {255, 255, 255, 255}, 3.0));
