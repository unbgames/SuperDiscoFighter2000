...
Player::Player(GameObject& associated) : Component(associated)
{
    ...
    Sprite* sprite = new Sprite(associated, ASSETS_PATH("/img/player_iddle.png"), 4, 1);
...
void Player::Update(float dt)
{
    if(state == PUNCH)
    {
        ...
        if (punchTimer.Get() > punchOffset)
        {
            ...
            associated.AddComponent(new Sprite(associated, ASSETS_PATH("/img/player_iddle.png"), 4, 1));
        }
    }
}
...
{
    // associated.RemoveComponent((Sprite *)associated.GetComponent("Sprite"));
    // associated.AddComponent(new Sprite(associated, ASSETS_PATH("/img/player_damage.png"), 1, 1, 2));
}
...
void Player::Punch(){
    ...
    {      
        associated.AddComponent(new Sprite(associated, ASSETS_PATH("/img/player_punch_up.png"), 3, 1));
    }
    else
    {
        associated.AddComponent(new Sprite(associated, (rand()%2 == 1 ? ASSETS_PATH("/img/player_punch_left.png") : ASSETS_PATH("/img/player_punch_right.png")), 5, 0.6));
    }
}
